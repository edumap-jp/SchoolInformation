	...
	public $records = array(
		'Plugin' => array(
			...
			array(
				...
				'namespace' => 'netcommons/school_informations',
				'name' => '学校情報',
				'type' => 1,
				'default_action' => 'school_informations/view',
				'default_setting_action' => 'school_information_frame_settings/edit',
				'frame_add_action' => 'school_information_frame_settings/edit',
				'display_topics' => 1,
				'display_search' => 1,
			),
			//英語
