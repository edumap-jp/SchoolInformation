<?php
class CreateSchoolInformations extends CakeMigration {
 ...
 * @var string
 */
	public $description = 'create_school_informations';
		...
		'up' => array(
			'create_table' => array(
				'school_informations' => array(
					...
					'fax' => array('type' => 'string', 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => 'FAX番号', 'charset' => 'utf8mb4'),
