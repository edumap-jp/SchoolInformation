<?php
/**
 * 種別を「小中一貫校・義務教育学校」から「小中一貫校・義務教育学校等」に変更
 *
 ...
 * https://github.com/edumap-jp/Edumap2/issues/136
 */
class UpdateElementaryAndJuniorHighSchoolEtc extends NetCommonsMigration {
 ...
 * @var string
 */
	public $description = 'update_elementary_and_junior_high_school_etc';
 ...
 */
	public function after($direction) {
		...
		$update = [
			'SchoolInformation.school_kind' => '\'小中一貫校・義務教育学校等\''
		];
		$conditions = [
