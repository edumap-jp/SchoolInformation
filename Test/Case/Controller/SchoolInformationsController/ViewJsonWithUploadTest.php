 ...
 */
class SchoolInformationsControllerViewJsonWithUploadTest extends NetCommonsControllerTestCase {
 ...
 */
	public $fixtures = [
		...
		'plugin.school_informations.upload_file_for_school_information',
		'plugin.school_informations.upload_files_content_for_school_information',
	...
	public function dataProviderView() {
		...
		$results[0] = [
			...
			'expects' => [
				...
				'created_user' => '0',
				'modified_user' => '0',
				'school_badge' => $this->__baseUrl . '/school_informations/school_informations/school_badge.png',
				'cover_picture' => $this->__baseUrl . '/school_informations/school_informations/cover_picture.png',
			]
		];
